...
export const EducationSection: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            ...
            >
                <SkewedPanel variant="white" className="mb-8 px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                    <SkewedPanel variant="outline" className="h-full px-6">
                        <div className="flex items-center gap-2 mb-4 border-b border-white pb-2 ml-6">
                            <BookOpen size={20} />
                ...
                >
                    <SkewedPanel variant="outline" className="h-full px-6">
                        <div className="flex items-center gap-2 mb-4 border-b border-white pb-2 ml-3">
                            <Award size={20} />
